...
const messages = {
  ar: {
    cart: "السلة",
    wholesale: "لبيع الجملة",
    wholesaleWaiting: "بانتظار باقي التفاصيل من قبلكم",
    headerDescription: "Taste the World Through the Coffee",
    menu: "القائمة",
    menuClose: "إغلاق",
    menuWebsite: "الموقع الرئيسي",
    learnMore: "اعرف المزيد",
    ourWebsite: "موقعنا الرئيسي",
    all: "الكل",
    viewAll: "عرض الكل",
  ...
  en: {
    ...
    menu: "Menu",
    menuClose: "Close",
    menuWebsite: "Main website",
    learnMore: "Learn more",
    ourWebsite: "Our main website",
    all: "All",
    viewAll: "View all",
