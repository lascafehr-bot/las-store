...
const messages = {
  ar: {
    ...
    menu: "القائمة",
    wholesale: "بيع الجملة",
    wholesaleWaiting: "بانتظار باقي التفاصيل من قبلكم",
    headerDescription: "قهوة ومنتجات لاس — ببساطة",
    learnMore: "اعرف المزيد",
    learnMoreCta: "الموقع الرئيسي",
    soon: "قريباً",
    all: "الكل",
    viewAll: "عرض الكل",
  ...
  en: {
    ...
    headerDescription: "LAS CAFE coffee and products — simply",
    learnMore: "Learn more",
    learnMoreCta: "Main website",
    soon: "Coming soon",
    all: "All",
    viewAll: "View all",
